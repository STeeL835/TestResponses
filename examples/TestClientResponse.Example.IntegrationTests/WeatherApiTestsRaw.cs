...
public class WeatherApiTestsRaw(TestFixture fixture)
{
    ...
    {
        var httpResponse = await _httpClient.GetAsync($"/weather/Saratov/today");
    ...
    {
        var httpResponse = await _httpClient.GetAsync($"/weather/Samara/today");
        var dto = await httpResponse.Content.ReadFromJsonAsync<WeatherForecast>();
    ...
    {
        var httpResponse = await _httpClient.GetAsync($"/weather/Balakovo/today");
